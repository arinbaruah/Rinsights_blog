---
title: "Utilisation of layered radar plots to understand how two entities differ from one another"
...
!["Source: Google images"](https://y9s5q4c4.stackpathcdn.com/wp-content/uploads/2021/07/enzymology-1.png)
...
Based on the analysis from figures @fig-KappVMorgEC1 and @fig-KappVMorgEC2, we can observe that 
...
Based on figures @fig-EStateVSA8EC1 and @fig-EStateVSA8EC2, we can observe that
...
#| label: fig-radplot
#| fig-cap: "Median standaridised values for EC1 and EC2 indicators" 
EC_imp <- EC1_imp
