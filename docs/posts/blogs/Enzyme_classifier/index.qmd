...
Based on the figure @fig-missvis, we can observe that
...
#| label: fig-KappVMorgEC1
#| fig-cap: "Kappa3 Vs FpDensityMorgan1 for EC1" 
...
```{r gbmec1,fig.cap="Feature importance with GBDT for EC1",fig.align='center',echo=TRUE}
...
```{r gbmec2,fig.cap="Feature importance with GBDT for EC2",fig.align='center',echo=TRUE}
