...
Additionally, the study will make the use of a grand tour and a 3D scatter plot which will allow us to study the data points in a high-dimensional space.
