...
```{r}
#| label: fig-scatter3d
#| fig-cap: '3D Scatter plot matrix for PC distribution of each player'
...
Based on our analysis of the 3 PCs in @fig-scatter3d, we can observe that while most players cluster into one region as shown by the dark blue shaded points, there are however some outliers in the data which suggest that these players have better cricketing statistics in certain domains than the rest of the set of players.
