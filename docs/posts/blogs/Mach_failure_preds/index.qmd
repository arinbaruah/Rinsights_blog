---
title: "⚙️⚠️ Can we accurately predict if a machine is going to undergo failure using machine learning ?"
author: "Arindam Baruah"
date: "2024-04-23"
categories: [R,analysis,exploratory data analysis,visualisation,statistics,machine learning,regression,classification]
...
```{r}
#| label: fig-fail
#| fig-cap: "Source: www.gesrepair.com" 
...
```{r read-data}
#| label: tbl-train
#| tbl-cap: "Glimpse of the train dataset"
df_train <- read_csv("data/train.csv")
df_test <-  read_csv("data/test.csv")

kbl(head(df_train)) %>% kable_paper(font_size = 9) %>%
...
#| label: fig-failtype
#| fig-cap: "Number of machine failures for each type"
...
<div class="alert alert-info">
 📵 <strong> Hence, we can observe that the number of failure cases are fairly evenly distributed among each of the machine types. </strong> 📵 .
</div>
...
#| label: fig-temps
#| fig-cap: "Temperature variation distribution"
...
#| label: fig-tempdiff
#| fig-cap: "Heat dissipation failure based on temperature difference" 
...
#| label: fig-pwf
#| fig-cap: "Working window of Torque and Rotational speeds"
...
#| label: fig-facetwindown
#| fig-cap: "Faceted hex plot of working windows for each machine type" 
...
#| label: fig-power
#| fig-cap: "Probability density of power consumption for each PWF status" 
...
#| label: fig-toolwear
#| fig-cap: "Tool wear values for overstrain failure status (OSF) faceted for each machine type" 
...
```{r corrplot}
#| label: fig-corrplot
#| fig-cap: "Correlation plot for the various features in the data"
...
#| label: fig-roclogit
#| fig-cap: "Receiver Operating Curve for Logistic Regression"
...
#| label: fig-errormod
#| fig-cap: "Error vs Number of trees for Random Forest"
...
<div class="alert alert-info">
 💡 the error of the random forest model is observed to reduce <strong> as the number of trees cross 100 </strong>. 💡
</div>

```{r conf-mat-rf,fig.cap="Confusion matrix of the random forest model",fig.align='center'}
#| label: fig-confmatrf
#| fig-cap: "Confusion matrix of the random forest model" 
