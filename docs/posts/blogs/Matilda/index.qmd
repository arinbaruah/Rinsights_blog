...
date: "2024-11-14"
categories: [R,exploratory data analysis,visualisation,statistics]
image: "Resized_merged.png"
...
![Source: www.solhapp.com](mental_health.webp)
...
## Males are disproportionately more affected by drug use mortality
...
x = `Total deaths from drug use disorders among females`)) + geom_point(color = "lightgray") +
  ...
  labs(x =     "Female deaths",
       ...
       caption = str_glue("{li} Arindam Baruah | {X_icon} @wizsights | {gh} arinbaruah | Source: IHME, Global Burden of Disease, 2021 |#Rstudio #ggplot2")) +
...
![Drug use disorders across gender](images/Gender_death_rate.jpeg){#fig-gender}

## The USA and Canada are the worst affected by mental health and drug use deaths
...
gr2 <- ggplot(data = df_substance_deaths %>% filter(Entity %in% tags) , aes(x = Year,
  ...
  label = 'COVID-19', size = unit(10, "pt")
         ...
         caption = str_glue("{li} Arindam Baruah | {X_icon} @wizsights | {gh} arinbaruah | #Rstudio #ggplot2 | Source: World Health Organisation")) +
...
```
![Rising global deaths due to mental health and substance use across the world](images/Global_death_rate.jpeg){#fig-geography}
...
## Deaths among those aged 15-49 are persistently higher

![Death trends from mental health and substance use across age groups](images/Global_death_rate_age.jpeg){#fig-age}

## Global survey of employers indicates that significant progress is still needed to adequately protect employees from mental health challenges.

![Global survey indicating the attitude of employers with regards to mental health](images/mental_health_survey.jpeg){#fig-survey}


## Higher risk of drug use for those diagnosed with mental health conditions
...
![Statistically higher risk of drug use for diagnosed mental health conditions](images/drug_dependency.jpeg){#fig-depend}
...
## Tobacco remains the most lethal substance of abuse

![Substances causing the highest deaths](images/tobacco_deaths.jpeg){#fig-tobacco}
...
## Encouraging news: Cigarette consumption is on the decline

![Declining global cigarette consumption and its associated deaths](images/cig_sales.jpeg){#fig-sales}
...
## Concerning news: The global consumption of synthetic opioids is on the rise

![Sharp rise in overdose deaths due to synthetic opioids](images/overdose_deaths.jpeg){#fig-overdose}
