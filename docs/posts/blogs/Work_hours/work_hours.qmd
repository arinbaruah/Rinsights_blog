...
Figure @fig-plot1 is a scatter plot between the annual working hours and the GDP per capita of some of the nations of concern in the current study.
...
#| label: fig-plot4
#| fig-cap: "Rise of productivity over time (in terms of GDP)"
pl2 <- ggplot(df_productivity, aes(x = Year, y = `Productivity: output per hour worked`, group = Entity)) + 
  geom_line(size = 2, color = "lightgray", alpha = 0.4) + 
  geom_point(size = 3, color = "lightgray", alpha = 0.4) + 
  theme_economist() + 
  ggtitle("Are we observing a rise in productivity over time ?") + 
  ylab("Productivity: in GDP $/Hour") + 
